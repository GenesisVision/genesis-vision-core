...
import { $mainColor, $textDarkColor, $textColor } from "styles/colors";
import { fontSize, height } from "styles/mixins";
import { $fontSizeH4, $fontSizeSmall, $fontSizeXsmall } from "styles/sizes";
