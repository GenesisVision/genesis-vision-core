...
contract GenesisProgramsFactory is
    IGenesisProgramsFactory
{
    function createProgram(
        ...
        external override
        returns (address) {
            GenesisProgram program = new GenesisProgram(_name, _ticker, _assetsWhiteList, _genesis, amount, managementFee, _cofferSettings);
